...
export function Navbar() {
  ...
  const isHeroPage = isHomepage || pathname === "/story" || pathname.startsWith("/collections/");
          ...
          <div className="flex items-center gap-4">
            {mounted && (
              <button
                ...
                className={`p-2 rounded-full transition-colors ${useWhiteText ? "hover:bg-white/10" : "hover:bg-muted"}`}
