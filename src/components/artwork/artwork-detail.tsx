...
import { getFullUrl, getThumbnailUrl } from "@/lib/image-utils";
...
export function ArtworkDetail({ artwork, similarArtworks }: ArtworkDetailProps) {
  ...
  const rawImage = artwork.images[selectedImage]?.image_url || "/images/placeholder.svg";
  const currentImage = getFullUrl(rawImage);
